...
* Summarize commune-level analyses in repframe format (tree cover variable test)
* 05.03.2026
* Author: Kirara Homma
*===================================================================================
...
save "D:\Shared Data\homma\PhD_2025\Replication_game\output\repframe_commune.dta", replace

* output
** table
export delimited "D:\Shared Data\homma\PhD_2025\Replication_game\output\repframe_commune.csv", replace